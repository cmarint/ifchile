                    ...
                    <!-- Widget: user widget style 1 -->
                        <div class="box box-widget widget-user-2">
                            ...
                            <ul class="nav nav-stacked">
                                <li><a href="#">Monto <span class="pull-right text-black">{{ngDialogData.datos.Monto| currency: "$": 0}}</span></a></li>
                                ...
                                <li><a href="#">Utilidad <span ng-show="ngDialogData.datos.isSeguro==0" class="pull-right text-black">{{ngDialogData.datos.UtilidadReal| currency: "$": 0}}</span><span ng-show="ngDialogData.datos.isSeguro==1" class="pull-right text-black">{{ngDialogData.datos.UtilidadReal| currency: "$": 0}}</span></a></li>
