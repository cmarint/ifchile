...
<?php include "php/navbar.php"; ?>
	...
	<div class="container" ng-controller="reporteController as oReporte" data-ng-init="oReporte.getFacturasPagadas(5)">
        ...
        <thead>
		<tr><th>ID</th><th>Emisor</th><th>Pagador</th><th>Monto Factura</th><th>Tasa Mora</th><th>Monto Mora</th><th>Fecha Publicación</th><th>Fecha Vencimiento</th><th>Fecha Compra</th><th>Estado</th><th>Inversionista</th></tr></tr>
        <thead>
        </table>
